...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { caffe_id: @opinion.caffe_id, comment: @opinion.comment, rating: @opinion.rating }
    end
  ...
  test "should update opinion" do
    put :update, id: @opinion, opinion: { caffe_id: @opinion.caffe_id, comment: @opinion.comment, rating: @opinion.rating }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
